...
<nav class="navbar navbar-light bg-light">
  ...
  <ul class="nav">
    ...
    <c:when test="${user!= null}">
   	 <li class="nav-item">
   		<a class="nav-link" href="/usermanager.do">
		<img alt="" src="/images/zhangge.jpg" style="max-height: 2.5rem" class="rounded img-fluid">
   		</a>
   	 </li>
   	 <li class="nav-item">
		  ...
		  <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton">
		    <a class="dropdown-item" href="toMyHome.do">个人主页</a>
		    <a class="dropdown-item" href="toMyHome.do">个人设置</a>
		    <a class="dropdown-item" href="toMyHome.do">我的文章</a>
